<template>
   <div v-if="editProduct" class="font-mono fixed inset-0 z-50 flex items-center justify-center backdrop-blur-sm">
      <div class="flex flex-col items-center justify-center bg-dark-theme-950 max-w-4xl w-full p-6 rounded-sm border border-dark-theme-800">
         <!-- Form -->
         <form @submit.prevent="handleEditProduct" class="flex flex-col items-baseline justify-center gap-4 w-full">
            <!-- Big Title -->
            <div class="flex flex-col gap-2 w-full">
               <div class="text-dark-theme-50 flex flex-row items-center justify-between">
                  <span class="text-lg font-medium tracking-tight">Edit informasi produk.</span>
               ...
               <div>
                  <span class="text-dark-theme-400 text-base font-normal tracking-tight">Edit data produk yang dibuat oleh anda untuk diperbarui.</span>
               </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4 w-full">
               ...
               <div class="flex flex-col gap-2">
                  ...
                  <!-- Input Box -->
                  <div @click="photoInput.click()" class="relative text-dark-theme-400 w-full h-full rounded-sm border border-dark-theme-800 bg-dark-theme-900 overflow-hidden flex flex-col items-center justify-center gap-2 cursor-pointer hover:bg-dark-theme-800 transition-all">
...
const props = defineProps({
   idProduct: { type: [Number, String], default: null },
   productName: { type: String, default: '' },
   productPhoto: { type: String, default: '' },
   productStock: { type: [Number, String], default: '' },
   productPrice: { type: String, default: '' },
   productDescription: { type: String, default: '' },
   productType: { type: String, default: '' },
   productStatus: { type: String, default: '' },
   productEstimate: { type: String, default: '' },
...
const handleEditProduct = async () => {
   ...
   const data = await productStore.update(props.idProduct)
   ...
   if (data?.success) {
      ...
      error.value = data?.message || 'Gagal memperbarui produk!'
   }

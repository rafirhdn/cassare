<template>
   <div v-if="addCategory" class="fixed inset-0 z-50 flex items-center justify-center backdrop-blur-sm">
      <div class="flex flex-col items-center justify-center bg-dark-theme-950 max-w-xl w-full p-6 rounded-sm border border-dark-theme-800">
         <!-- Form -->
         <form @submit.prevent="handleAddCategory" class="w-full flex flex-col items-baseline justify-center gap-4">
            <!-- Big Title -->
            <div class="flex flex-col gap-2 w-full">
               ...
               <!-- Small Title -->
               <div>
                  <span class="text-dark-theme-400 text-base font-normal tracking-tight">Tambahkan gambar dan nama untuk membuat kategori baru.</span>
               </div>
            </div>

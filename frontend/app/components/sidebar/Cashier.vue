<template>
   <div class="max-w-3xs w-full overflow-y-auto h-screen flex flex-col items-baseline gap bg-dark-theme-900 border-r border-dark-theme-800 font-mono text-dark-theme-50">
      <!-- Wrapper -->

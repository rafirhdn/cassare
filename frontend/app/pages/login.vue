      ...
      <div class="flex flex-col items-center justify-center max-w-sm w-full">
         ...
         <form @submit.prevent="handleLogin" class="flex flex-col gap-6 font-mono w-full">
            ...
            <div class="flex flex-col gap-2 items-baseline justify-baseline w-full">
               ...
               <!-- Small title -->
               <span class="text-dark-theme-400 text-base font-normal tracking-tight">Masukkan email dan password di bawah untuk masuk akun anda.</span>
            </div>
            ...
            <div class="flex flex-col gap-2 items-baseline justify-baseline w-full">
               ...
               <div class="flex flex-row w-full">
                  <input v-model="email" class="placeholder:text-dark-theme-400 text-base tracking-tight text-dark-theme-50 bg-dark-theme-900 w-full px-4 py-2 rounded-sm focus:outline-2 focus:outline-dark-theme-100 border border-dark-theme-800" type="email" placeholder="Masukkan email anda" />
               </div>
            </div>
            ...
            <div class="flex flex-col gap-2 items-baseline justify-baseline w-full">
               ...
               <!-- Input Box -->
               <div class="flex flex-row w-full">
                  <input v-model="password" class="placeholder:text-dark-theme-400 text-base tracking-tight text-dark-theme-50 bg-dark-theme-900 w-full px-4 py-2 rounded-sm focus:outline-2 focus:outline-dark-theme-100 border border-dark-theme-800" type="password" placeholder="Masukkan password anda" />
               </div>
            </div>
